    ...
    <div class="collapse navbar-collapse" id="navbarNav">
     ...
     <Link href="/" className="nav-link" >Home</Link>
        ...
        <li class="nav-item">
          ...
          <Link href="/components/quiz" className="nav-link">
                Quiz
                </Link>
        </li>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
        <Link href="/"></Link>   <a class="nav-link active" aria-current="page" href="#">Home</a>
        </li>
        <li class="nav-item">
        <Link href="/components/quiz"><a class="nav-link activate">Link</a></Link>
        </li>
